...
// Project 1Doc.cpp : implementation of the CProject1Doc class
//
...
BOOL CProject1Doc::OnNewDocument()
{
 ...
 void CProject1Doc::SetTitle(LPCTSTR lpszTitle) 
     {
		 CDocument::SetTitle(_T("Process Scheduling Algorithms"));
     }
